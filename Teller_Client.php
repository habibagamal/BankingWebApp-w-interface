  ...
  <body>
    <!-- NAVIGATION -->
      ...
      <div class="collapse" id="navbarToggleExternalContent">
        ...
        <button type="button" class="btn btn-danger" >TELLER & Client</button>
        </div>
      </div>
    </div>
    ...
    <!--Cards-->
     <br>
      ...
      <div class="btn-group dropdown d-flex justify-content-center align-items-center">
        <button type="button" class="btn btn-secondary"><a href ="ChangePassword.php" style="color:white">Change MY Password</button></a>
      </div>
      ...
      <div class="btn-group dropdown d-flex justify-content-center align-items-center">
        <button type="button" class="btn btn-secondary"><a href ="UpdateContactInfo.php" style="color:white">Update MY Contact Info</button></a>
      </div>
      ...
      <div class="btn-group dropdown d-flex justify-content-center align-items-center">
        <button type="button" class="btn btn-secondary"><a href ="Accounts.php" style="color:white">View MY Accounts</button></a>
      </div>
